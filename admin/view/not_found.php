...
?>
  ...
  <div class="container h-100">
    <div class="row align-items-center justify-content-start">
      <div class="col-md-6 mt-5">
        ...
        <div class="notFound">
          <div><h1>Упс!</h1></div>
          <div class="mb-5"><h4>Страница <?php echo $page_name?> не найдена</h4></div>
          <div>
        ...
        <img class="image404" src="<?php echo $pagedot_dir?>/img/404.png" alt="">
  ...
  <script>
    var pagedot_api_url = '';
    var pagedot_dir = '<?php echo $pagedot_dir; ?>';
  </script>
